...
| 12 | SSH key for devbox5 | | Security | SSH authentication keys for accessing the devbox5 development machine. |

### Additional Development Tools (To Be Installed)

| Install Order | Tool | Screenshot | Category | Description |
|--------------|------|------------|----------|-------------|
| 1 | Magic, Mojo | | Programming | Modern programming language for AI development with Python compatibility. |
| 2 | Magic Mojo completions | | Development | Command-line completions for Magic Mojo commands. |
| 3 | NeoVim | | Text Editor | Hyperextensible Vim-based text editor focused on extensibility and usability. |
| 4 | Atuin | | Shell Enhancement | A magical shell history that synchronizes across all your machines. |
| 5 | Starship | | Shell Enhancement | A minimal, blazing-fast, and customizable prompt for any shell. |
| 6 | Zelij | | Terminal | A terminal workspace with batteries included, featuring multiplexer capabilities. |

## Developer Tools

| Install Order | Application | Screenshot | Category | Description |
|--------------|-------------|------------|----------|-------------|
| 1 | TryAstro | | Development | A tool for exploring and testing applications built with the Astro web framework. |
| 2 | TestFlight | | Development | Apple's platform for testing beta versions of apps before they're released on the App Store. |
| 3 | Developer | | Development | Apple's developer app providing access to documentation, videos, and developer news. |
| 4 | SF Symbols | | Design | Apple's library of iconography designed to integrate with San Francisco, the system font for Apple platforms. |

## Productivity

| Install Order | Application | Screenshot | Category | Description |
|--------------|-------------|------------|----------|-------------|
| 1 | Goodnotes | | Productivity | A digital note-taking app that allows you to write, draw, annotate PDFs, and organize your notes. |
| 2 | MindNode | | Productivity | A mind mapping app that helps you organize your thoughts and visualize your ideas. |

## Video & Creative

| Install Order | Application | Screenshot | Category | Description |
|--------------|-------------|------------|----------|-------------|
| 1 | Pixelmator | | Photo & Video | A powerful, full-featured image editor with tools for enhancing photos, drawing, and creating graphic designs. |
| 2 | Blackmagic Cloud | | Video Production | Cloud collaboration tools for DaVinci Resolve projects, allowing teams to work together remotely. |
| 3 | Converters | | Video Production | Blackmagic Design's software for configuring video conversion hardware. |
| 4 | Hyperdeck | | Video Production | Control software for Blackmagic Design's HyperDeck video recorders. |
| 5 | Desktop Video | | Video Production | Blackmagic Design's software for configuring capture and playback devices. |
| 6 | Atem software control | | Video Production | Control software for Blackmagic Design's ATEM video switchers. |
| 7 | Resolve Studio | | Video Editing | Professional video editing, color correction, visual effects, and audio post-production software. |
| 8 | Cloud Store Setup | | Storage | Setup utility for Blackmagic Design's Cloud Store network storage solution. |
| 9 | M32 edit | | Audio | Control software for the Midas M32 digital mixing console. |
| 10 | Dante controller | | Audio | Network configuration and routing software for Dante audio networking. |
| 11 | Mixeffect pro | | Video Production | Advanced control software for Blackmagic Design ATEM switchers. |
| 12 | Insta Studio | | Video | Editing software for 360° content from Insta360 cameras. |
| 13 | Sidas Link Pro | | Video Production | Professional video linking and synchronization software. |
